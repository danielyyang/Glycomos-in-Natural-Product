...
from sugar_sequence import analyze_glycan
...
def characterizeAglycon(smiles: str) -> Dict[str, str]:
    """
    苷元一站式特征化: Morgan FP + Murcko Scaffold + 基本描述符。
    One-stop aglycone characterization: Morgan FP + Murcko Scaffold + basic descriptors.

    Args:
        smiles: Aglycon SMILES

    Returns:
        字典包含: morgan_fp, murcko_scaffold, molecular_weight, ring_count
    """
    result = {
        "morgan_fp": "",
